...
class Read : public ::sdg::ReadStrategy
{
    ...
    virtual void configure_analyzer(SemanticAnalyzer &semantic_analyzer, std::shared_ptr<DataSet> data_set, std::shared_ptr<SyntaxNode> syntax_tree) const override;
